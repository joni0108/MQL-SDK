...
void COneClickTradingWindow::ClickBuy(void)
  {
   ...
   SetActiveWindow(GetParent(GetParent(handle)));
...
void COneClickTradingWindow::SetLots(double val)
  {
   ...
   string volumestringarray[];
   StringToStringArray(valstring, volumestringarray);
...
bool CheckClickOnceActivated()
  {
   if(ChartGetInteger(0, CHART_SHOW_ONE_CLICK) == TRUE)
      return true;
